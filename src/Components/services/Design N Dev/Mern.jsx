...
import slogo from "D:/DST/data_smart_tech/src/assets/mern.webp";
import "../Services.css";
import { Link } from "react-scroll";

export default function MERN() {
  return (
    <div className="row service-page" id="MERN">
      <h3 className="sub-heading">MEAN, MERN, MEEN, MEVN Stacks</h3>
