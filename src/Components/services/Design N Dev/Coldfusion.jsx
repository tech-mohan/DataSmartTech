...
import slogo from "D:/DST/data_smart_tech/src/assets/CFML.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function Coldfusion() {
  return (
    <div className="row service-page" id="Coldfusion">
      <h3 className="sub-heading">Cold Fusion ,CFML</h3>
