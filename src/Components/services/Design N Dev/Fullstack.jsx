...
import slogo from "D:/DST/data_smart_tech/src/assets/FS.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function Fullstack() {
  return (
    <div className="row service-page" id="Fullstack">
      <h3 className="sub-heading">Full Stack, java, JS, Hibernate, JSP</h3>
