...
import slogo from "D:/DST/data_smart_tech/src/assets/mainframeapps.svg";
import "../Services.css";
import { Link } from "react-scroll";

export default function Mainframe() {
  return (
    <div className="row service-page" id="Mainframe">
      <h3 className="sub-heading">Mainframe Apps Enhancement</h3>
