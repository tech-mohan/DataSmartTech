...
import slogo from "D:/DST/data_smart_tech/src/assets/RPA.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function RPA() {
  return (
    <div className="row service-page" id="RPA">
      <h3 className="sub-heading">Robotics Process Animation RPA</h3>
