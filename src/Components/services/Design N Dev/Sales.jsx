...
import slogo from "D:/DST/data_smart_tech/src/assets/salesforce.webp";
import "../Services.css";
import { Link } from "react-scroll";

export default function Sales() {
  return (
    <div className="row service-page" id="Sales">
      <h3 className="sub-heading">Sales Force, CRM</h3>
      ...
      <div className="col-lg-6 col-md-12 col-sm-12">
        <img src={slogo} alt="" className="sales-logo" />
      </div>
