...
import slogo from "D:/DST/data_smart_tech/src/assets/robot-2d.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function RoboticsTwoD() {
  return (
    <div className="row service-page" id="2D">
      <h3 className="sub-heading">Robotics 2D</h3>
