...
import slogo from "D:/DST/data_smart_tech/src/assets/oracle.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function Oracle() {
  return (
    <div className="row service-page" id="Oracle">
      <h3 className="sub-heading">Oracle Apps All Modules</h3>
