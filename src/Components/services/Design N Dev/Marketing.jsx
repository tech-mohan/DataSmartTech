...
import slogo from "D:/DST/data_smart_tech/src/assets/marketing.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function Marketing() {
  return (
    <div className="row service-page" id="Marketing">
      <h3 className="sub-heading">Digital N Social Media Marketing</h3>
