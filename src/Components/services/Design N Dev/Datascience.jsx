...
import slogo from "D:/DST/data_smart_tech/src/assets/python.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function Datascience() {
  return (
    <div className="row service-page" id="Datascience">
      <h3 className="sub-heading">Data Science, AI, ML, DL, NLP, PYTHON</h3>
