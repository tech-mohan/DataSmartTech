...
import slogo from "D:/DST/data_smart_tech/src/assets/Rstudio.png";
import "../Services.css";
import { Link } from "react-scroll";

export default function Studio() {
  return (
    <div className="row service-page" id="Studio">
      <h3 className="sub-heading">Statistical Apps, R Studio</h3>
